...
const personas = [
  ...
  },
  {
    type: "problem-solver",
    icon: ArrowRight,
    title: "The Problem-Solver (U-Turn)",
    emoji: "🔄",
    description: "I want to switch my career path",
    question: "How do I pivot successfully?",
    details:
      "You have experience but want a fresh start. You need a strategic roadmap to transfer your skills into a completely new industry.",
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center space-y-6 mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold gradient-text">CareerDreamer</h1>
          </div>
